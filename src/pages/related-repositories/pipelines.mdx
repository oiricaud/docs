...
This repository includes a set of custom [pipelines](https://github.com/ibm-garage-ref-storefront/devops-pipelines/tree/master/pipelines)
...
Install the following CLI's on your laptop/workstation:
  ...
  + [Tools Kit created by the Catalyst Team](www.google.com)
    

# How to add our custom pipelines to your cluster
To add the custom pipelines we created as shown in the Overview section run the following steps.
